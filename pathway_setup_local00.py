...
f1=open('pathway_ISG_record.txt', 'w')
f2=open('pathway_ISG-NE_distance.xvg', 'w')
...
D_GRANULES = 3.2E-5 # A^2/fs, 10 times of the real diffusion coeff.
#question:表格中是3.2*10^(-10)A^2/fs
N_GLUCOSE = 6.02e19 #
...
SIM_TIME_SEC= 1E-6 # a total simulation time of 100 ns
