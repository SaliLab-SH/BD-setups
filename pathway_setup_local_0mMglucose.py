...
f1=open('pathway_ISG_record_0mMglucose.txt', 'w')
f2=open('pathway_ISG-NE_distance_0mMglucose.xvg', 'w')
f3=open('pathway_ISG-secretion-along-time_0mMglucose.xvg','w')
...
rmf = RMF.create_rmf_file("pathway_25mMglucose_12_12.rmf")
